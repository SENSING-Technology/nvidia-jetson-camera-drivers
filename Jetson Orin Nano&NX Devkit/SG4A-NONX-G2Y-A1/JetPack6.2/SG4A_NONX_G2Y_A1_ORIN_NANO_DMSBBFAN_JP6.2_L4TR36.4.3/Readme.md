...
1. Copy the driver package to the working directory of the Jetson device, such as “/home/nvidia”
   ...
   ```
   /home/nvidia/SG4A_NONX_G2Y_A1_ORIN_NANO_DMSBBFAN_JP6.2_L4TR36.4.3
   ```
2. Enter the driver directory

   ```
   cd SG4A_NONX_G2Y_A1_ORIN_NANO_DMSBBFAN_JP6.2_L4TR36.4.3
   ```
...
7. After the device reboots, install v4l-utils plugins, then enter the driver directory and run the script "quick_bring_up.sh".
   ...
   ```
8. Select Bring up one camera port
