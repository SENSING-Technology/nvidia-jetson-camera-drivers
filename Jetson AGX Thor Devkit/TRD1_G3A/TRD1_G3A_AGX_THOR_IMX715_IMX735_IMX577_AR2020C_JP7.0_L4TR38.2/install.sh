...
# add dtbo
sudo cp dtb/SG17_IMX735C_G3A/tegra264-camera-imx735x8-overlay.dtbo /boot/
sudo cp dtb/SG20_AR2020C_G3A/tegra264-camera-ar2020cx8-overlay.dtbo /boot/
sudo cp dtb/SG12_IMX577C_G3A/tegra264-camera-imx577x8-overlay.dtbo /boot/
sudo cp dtb/SG8_IMX715C_G3A/tegra264-camera-imx715x8-overlay.dtbo /boot/
# upgrade Image
