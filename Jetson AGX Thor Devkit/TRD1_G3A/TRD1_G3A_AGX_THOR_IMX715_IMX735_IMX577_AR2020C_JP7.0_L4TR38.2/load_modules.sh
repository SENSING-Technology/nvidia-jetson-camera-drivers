...
sudo rmmod sg17_imx735c_g3a >/dev/null 2>&1
sudo rmmod sg12_imx577c_g3a >/dev/null 2>&1
sudo rmmod sg20_ar2020c_g3a >/dev/null 2>&1
sudo rmmod sg8_imx715c_g3a >/dev/null 2>&1
...
#0sudo insmod ko/sg12-imx577c-g3a.ko
