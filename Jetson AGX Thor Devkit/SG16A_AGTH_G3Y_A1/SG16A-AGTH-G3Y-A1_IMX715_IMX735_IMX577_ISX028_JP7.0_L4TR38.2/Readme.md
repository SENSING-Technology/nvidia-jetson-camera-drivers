...
4. Use the "sudo /opt/nvidia/jetson-io/jetson-io.py" command to select the corresponding device.
   ...
   SG8-ISX028C-G2G-HXXX    Jetson Sensing SG16A_AGTH_G3Y_A1 YUV GMSL2x16    sgx-yuv-gmsl2.ko
   ```
...
5. After the device reboots, modify the "load_module.sh" script.
   ...
   Note: Only the SG12-IMX577C-G3A-HXXX 、SG8-ISX028C-G2G-HXXX and SG17-IMX735C-G3A-HXXX cameras support initialization in Jetson Orin Trigger Mode and External-Trigger Mode.
...
6. Bring up the camera
   ...
   Or use：
      ...
      videoconvert ! fpsdisplaysink video-sink=autovideosink text-overlay=true sync=false
      ```
