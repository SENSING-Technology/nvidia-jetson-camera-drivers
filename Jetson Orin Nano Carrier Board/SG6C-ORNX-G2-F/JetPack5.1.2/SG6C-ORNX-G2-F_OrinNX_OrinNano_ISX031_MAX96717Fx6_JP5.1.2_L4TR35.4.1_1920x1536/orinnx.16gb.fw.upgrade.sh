...
sudo cp /boot/dtb/kernel_tegra234-p3767-0000-p3768-0000-a0.dtb /boot/dtb/kernel_tegra234-p3767-0000-p3768-0000-a0.dtb.backup
sudo cp $PWD/kernel/Image /boot/Image
sudo cp $PWD/kernel/dtb/tegra234-p3767-0000-p3768-0000-a0.dtb /boot/dtb/kernel_tegra234-p3767-0000-p3768-0000-a0.dtb
sudo cp $PWD/extlinux.orinnx.16gb.conf $PWD/extlinux.conf.backup
