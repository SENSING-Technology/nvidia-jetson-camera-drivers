...
green_print 'Upgrade PPS modules'
sudo mkdir -p /lib/modules/$(uname -r)/kernel/drivers/pps/clients
sudo cp $PWD/ko/pps-gpio.ko /lib/modules/$(uname -r)/kernel/drivers/pps/clients/
sudo cp ko/load-pps-gpio.service /etc/systemd/system/
sudo systemctl enable load-pps-gpio.service
...
sudo cp /boot/dtb/kernel_tegra234-p3767-0004-p3768-0000-a0.dtb /boot/dtb/kernel_tegra234-p3767-0004-p3768-0000-a0.dtb.backup
sudo cp $PWD/kernel/Image /boot/Image
sudo cp $PWD/kernel/dtb/tegra234-p3767-0004-p3768-0000-a0.dtb /boot/dtb/kernel_tegra234-p3767-0004-p3768-0000-a0.dtb
sudo cp $PWD/extlinux.orinnano.4gb.conf $PWD/extlinux.conf.backup
