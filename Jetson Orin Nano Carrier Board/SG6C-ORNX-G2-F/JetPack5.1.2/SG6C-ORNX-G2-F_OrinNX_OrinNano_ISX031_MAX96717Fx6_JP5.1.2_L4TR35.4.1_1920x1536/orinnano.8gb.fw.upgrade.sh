...
sudo cp $PWD/kernel/dtb/tegra234-p3767-0003-p3768-0000-a0.dtb /boot/dtb/kernel_tegra234-p3767-0003-p3768-0000-a0.dtb
sudo cp $PWD/extlinux.orinnano.8gb.conf $PWD/extlinux.conf.backup
