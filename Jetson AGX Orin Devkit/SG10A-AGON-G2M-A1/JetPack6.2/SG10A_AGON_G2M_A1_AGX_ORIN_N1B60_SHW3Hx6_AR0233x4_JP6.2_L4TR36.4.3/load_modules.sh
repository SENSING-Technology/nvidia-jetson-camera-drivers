...
## sensor_modeA: 1 = Resolution 1920x1080, 2 = Resolution 1920x1536.
## gmsl_mode: 0 = 6G GMSL Mode; 1 = 3G GMSL Mode.
## trig_mode: 0 = No sync trigger used; 2 = Use AGX Orin's trigger signal for camera sync.
# for SH2-N1B60-G2A * 6 + SG2-AR0233C-5200-G2A * 4
...
# for SHW3H * 6 + SG2-AR0233C-5200-G2A * 4
