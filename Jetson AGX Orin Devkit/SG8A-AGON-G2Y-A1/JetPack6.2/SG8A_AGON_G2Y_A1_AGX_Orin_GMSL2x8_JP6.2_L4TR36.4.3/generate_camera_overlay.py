...
# Configuration
# Monocular cameras
MONOCULAR_MODELS = ["sgx-yuv-gmsl2","shw3g"]
# Stereo cameras (used in pairs)
STEREO_MODELS = ["sdv11nm1"]
...
MODEL_TO_DTS_FILE = {
    ...
    "shw3g": "dts/tegra234-camera-sgcam-shw3gx8-overlay.dts",
    "sdv11nm1":"dts/tegra234-camera-sgcam-sdv11nm1x4-overlay.dts"
}
