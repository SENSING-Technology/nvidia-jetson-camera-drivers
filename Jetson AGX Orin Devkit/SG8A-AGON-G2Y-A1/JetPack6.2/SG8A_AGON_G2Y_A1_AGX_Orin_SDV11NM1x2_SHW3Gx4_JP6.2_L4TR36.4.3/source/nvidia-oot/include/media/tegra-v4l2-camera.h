...
#define TEGRA_CAMERA_CID_SET_AE_CTRL_ID		(TEGRA_CAMERA_CID_BASE + 137)
#define TEGRA_CAMERA_CID_GET_AE_CTRL_ID		(TEGRA_CAMERA_CID_BASE + 138)
#define TEGRA_CAMERA_CID_GET_EXPOSURE_ID	(TEGRA_CAMERA_CID_BASE + 139)
#define TEGRA_CAMERA_CID_SET_EXPOSURE_ID	(TEGRA_CAMERA_CID_BASE + 140)
#define TEGRA_CAMERA_CID_GET_GAIN_ID		(TEGRA_CAMERA_CID_BASE + 141)
#define TEGRA_CAMERA_CID_SET_GAIN_ID		(TEGRA_CAMERA_CID_BASE + 142)
