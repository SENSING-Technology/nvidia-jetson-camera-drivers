...
sudo cp ISP_File/ar2020m.isp /var/nvidia/nvcam/settings/cam3_centerright.isp
sudo cp ISP_File/vb1940.isp /var/nvidia/nvcam/settings/cam4_topleft.isp
sudo cp ISP_File/vb1940.isp /var/nvidia/nvcam/settings/cam5_topright.isp
sudo cp ISP_File/vb1940.isp /var/nvidia/nvcam/settings/cam6_front.isp
sudo cp ISP_File/vb1940.isp /var/nvidia/nvcam/settings/cam7_rear.isp
sync
