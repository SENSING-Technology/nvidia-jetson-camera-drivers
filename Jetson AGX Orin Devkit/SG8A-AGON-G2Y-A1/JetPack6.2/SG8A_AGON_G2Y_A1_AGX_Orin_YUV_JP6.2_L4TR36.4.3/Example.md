...
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video0
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video1
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video2
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video3
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video4
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video5
...
v4l2-ctl --set-fmt-video=width=1920,height=1080 --set-ctrl bypass_mode=0,sensor_mode=1,trig_mode=2,trig_pin=0x00020007, -d /dev/video7
...
1.Navigate to the board driver package directory and enter the following command to load the internal trigger pin driver.
 ...
 b.Export PWM channel 0 (pwmchip5 is a newly generated node after loading the driver)
