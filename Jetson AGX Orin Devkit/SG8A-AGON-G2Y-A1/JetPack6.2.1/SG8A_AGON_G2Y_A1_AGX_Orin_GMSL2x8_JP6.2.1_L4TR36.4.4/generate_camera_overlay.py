...
# Configuration
# Monocular cameras
MONOCULAR_MODELS = ["imx728", "sgx-yuv-gmsl2"]
...
MODEL_TO_DTS_FILE = {
    "sgx-yuv-gmsl2": "dts/tegra234-camera-sgcam-yuv-gmsl2x8-overlay.dts",
    "imx728": "dts/tegra234-camera-sgcam-imx728x8-overlay.dts",
}

TPL_FILE, OUT_DTS, OUT_DTBO = "dts/tegra234-camera-sgcam-template-overlay.dts", "dts/tegra234-camera-sgcamx8-overlay.dts", "dts/tegra234-camera-sgcamx8-overlay.dtbo"
...
def main():
    ...
    for port_idx in range(8):
        addr = (port_idx + 26) if port_idx < 4 else ((port_idx - 4) + 26)
